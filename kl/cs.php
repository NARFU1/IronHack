...
">
    	...
    	">
            ...
            <div style="
                ...
                float: left;
            ">
                От рыбалки - до йоги. От походов - до фотосессий!
            </div>
            <div style="
                margin-top: 16px;
                width: 33%; 
            ...
            ">
                <div class="e_b1" style="
                    ...
                    font-size: 1.2em;
                    background: #777;
                    background-image: url('img111.jpeg');
            ...
            ">
                <div class="e_b1" style="
                    ...
                    font-size: 1.2em;
                    background: #777;
                    background-image: url('img112.jpeg');
                    background-size: cover;
                    background-repeat: no-repeat;
                    background-position: 50% 50%;
                ">
            ...
            ">
                <div class="e_b1" style="
                    ...
                    font-size: 1.2em;
                    background: #777;
                    background-image: url('img113.jpeg');
                    background-size: cover;
                    background-repeat: no-repeat;
                    background-position: 50% 50%;
                ">
            ...
            ">
                <div class="e_b1" style="
                    ...
                    font-size: 1.2em;
                    background: #777;
                    background-image: url('img1011.jpeg');
                    background-size: cover;
                    background-repeat: no-repeat;
                    background-position: 50% 50%;
                ">
...
муж на рыбалке
            ...
            ">
                <div class="e_b1" style="
                    ...
                    font-size: 1.2em;
                    background: #777;
                    background-image: url('img1012.jpeg');
                    background-size: cover;
                    background-repeat: no-repeat;
                    background-position: 50% 50%;
                ">
...
"Рыба народов мира"
            ...
            ">
                <div class="e_b1" style="
                    ...
                    font-size: 1.2em;
                    background: #777;
                    background-image: url('img1013.jpeg');
                    background-size: cover;
                    background-repeat: no-repeat;
                    background-position: 50% 50%;
                ">
...
"Ужин на двоих"
            ...
            ">
                <div class="e_b1" style="
                    ...
                    font-size: 1.2em;
                    background: #777;
                    background-image: url('img131.jpeg');
                    background-size: cover;
                    background-repeat: no-repeat;
                    background-position: 50% 50%;
                ">
            ...
            ">
                <div class="e_b1" style="
                    ...
                    font-size: 1.2em;
                    background: #777;
                    background-image: url('img132.jpeg');
                    background-size: cover;
                    background-repeat: no-repeat;
                    background-position: 50% 50%;
                ">
            ...
            ">
                <div class="e_b1" style="
                    ...
                    font-size: 1.2em;
                    background: #777;
                    background-image: url('img133.jpeg');
                    background-size: cover;
                    background-repeat: no-repeat;
                    background-position: 50% 50%;
                ">
            ...
            ">
                <div class="e_b1" style="
                    ...
                    font-size: 1.2em;
                    background: #777;
                    background-image: url('img141.jpeg');
                    background-size: cover;
                    background-repeat: no-repeat;
                    background-position: 50% 50%;
                ">
                </div>
семейная пешая экскурсия<br>
к домику егеря
            </div>       
            <div onclick="fvn();" class="e_b0" style="
                cursor: pointer;
            ...
            ">
                <div class="e_b1" style="
                    ...
                    font-size: 1.2em;
                    background: #777;
                    background-image: url('img142.jpeg');
                    background-size: cover;
                    background-repeat: no-repeat;
                    background-position: 50% 50%;
                ">
                </div>
семейная водная экскурсия<br>
к лотосам
            </div> 
            <div onclick="fvn();" class="e_b0" style="
                cursor: pointer;
            ...
            ">
                <div class="e_b1" style="
                    ...
                    font-size: 1.2em;
                    background: #777;
                    background-image: url('img143.jpeg');
                    background-size: cover;
                    background-repeat: no-repeat;
                    background-position: 50% 50%;
                ">
                </div>
семейный мастер-класс<br>
"Вместе готовим рыбу"
            </div> 
            ...
            ">
                <div class="e_b1" style="
                    ...
                    font-size: 1.2em;
                    background: #777;
                    background-image: url('img151.jpeg');
                    background-size: cover;
                    background-repeat: no-repeat;
                    background-position: 50% 50%;
                ">
...
Фестиваль огней
            ...
            ">
                <div class="e_b1" style="
                    ...
                    font-size: 1.2em;
                    background: #777;
                    background-image: url('img152.jpeg');
                    background-size: cover;
                    background-repeat: no-repeat;
                    background-position: 50% 50%;
                ">
...
"Каспий-оупен"
            ...
            ">
                <div class="e_b1" style="
                    ...
                    font-size: 1.2em;
                    background: #777;
                    background-image: url('img153.jpeg');
                    background-size: cover;
                    background-repeat: no-repeat;
                    background-position: 50% 50%;
                ">
